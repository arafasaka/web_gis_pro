...
<body>
  ...
  <div class="container">
        <div class="table-wrapper">         
            ...
            <?php echo form_open_multipart('index.php/bidang/do_upload');?>
            <th>Unggah Bidang Baru</th>   
            <input class="btn btn-warning btn-sm"type="file" name="file"><br>
            <button class="btn btn-primary btn-md" type="submit">Upload GeoJson</button><br><br>
            <?php echo form_close(); ?>
            ...
            <?php } ?>
            <a class="btn btn-danger" href="<?php echo base_url('bidang/print') ?>"> <i class="fa fa-print"></i> EXPORT</a>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                        ...
                        <td>
                            ...
                            <a href='<?=base_url().'bidang/edit/' . $b->bidang_kode?>'   class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href='<?=base_url().'bidang/hapus/' . $b->bidang_kode?>' class='delete' title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i>
                            </a>
                            <?php } ?>
                        </td>
                        <?php } ?>
